...
If your cluster is running Couchbase Server 5.5.0, 5.5.1, 5.5.2, or 6.0.0 *and* already has IPv6 enabled using the older `static_config` method, see <<legacy-ipv6-config,Legacy IPv6 Setup>>.
====
