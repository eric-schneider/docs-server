...
[abstract]
Upgrading Couchbase Server helps improve the performance of your cluster and allows you to take advantage of the latest features. 
Because of Couchbase Server's distributed design, upgrading a cluster usually incurs zero downtime.
...
Once all nodes in the cluster have been fully upgraded, rollback window is closed.
